...
export default function Hero() {
  return (
    <div className="relative w-full">
      ...
      <section className="bg-gh-white py-32 px-6">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-[600px]">
             <div className="relative group overflow-hidden cursor-pointer">
                <Image src="/grassland_banner_1_1767749428961.png" alt="Men's" fill className="object-cover grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" />
             ...
             <div className="grid grid-rows-2 gap-8">
                <div className="relative group overflow-hidden cursor-pointer">
                   <Image src="/grassland_banner_2_1767749443673.png" alt="Women's" fill className="object-cover transition-all duration-700 group-hover:scale-105" />
                   <div className="absolute inset-0 bg-black/20" />
                ...
                <div className="relative group overflow-hidden cursor-pointer">
                   <Image src="/grassland_banner_3_1767749460228.png" alt="Tech" fill className="object-cover transition-all duration-700 group-hover:scale-105" />
                   <div className="absolute inset-0 bg-black/20" />
                   <div className="absolute bottom-6 left-6">
